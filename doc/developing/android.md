...
## How to get debug output from Wintercraft Reborn on Android

In case debug.txt isn't enough (e.g. when debugging a crash), you can get debug
output using logcat:

`adb logcat '*:F' | grep com.novaxgames.wintercraftreborn`
...
```
01-10 17:20:22.215 19308 20560 F libc    : Fatal signal 6 (SIGABRT), code -1 (SI_QUEUE) in tid 20560 (MinetestNativeT), pid 19308 (com.novaxgames.wintercraftreborn)
...
01-10 17:20:22.288 20576 20576 F DEBUG   : pid: 19308, tid: 20560, name: MinetestNativeT  >>> com.novaxgames.wintercraftreborn <<<
...
Erase the app's memory of which version was installed: `adb shell run-as com.novaxgames.wintercraftreborn rm shared_prefs/WintercraftRebornSettings.xml`

If this doesn't work you can also uninstall it using `adb shell pm uninstall com.novaxgames.wintercraftreborn`. You will obviously lose your data.
