...
libraries, build tools (CMake) or compilers Wintercraft Reborn requires.
...
Being able to play Wintercraft Reborn on a recent low-end phone is a reasonable target.
...
* Can we make it easier for users to build the library together with Wintercraft Reborn?
