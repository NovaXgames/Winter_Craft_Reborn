...
General options and their default values:
    ...
    BUILD_CLIENT=TRUE          - Build Wintercraft Reborn client
    BUILD_SERVER=FALSE         - Build Wintercraft Reborn server
    ...
    INSTALL_DEVTEST=FALSE      - Whether the Development Test game should be installed alongside Wintercraft Reborn
    ...
    VERSION_EXTRA=             - Text to append to version (e.g. VERSION_EXTRA=foobar -> Wintercraft Reborn 5.10.0-foobar)
