...
When you open the Wintercraft Reborn folder with VSCode, you should get a quick pick asking you for the default preset.
...
[Vcpkg](https://vcpkg.io) is the recommended way of installing Wintercraft Reborn dependencies.

Follow the official documentation to install it and install Wintercraft Reborn dependencies as explained in [Windows compilation process](../compiling/windows.md).
